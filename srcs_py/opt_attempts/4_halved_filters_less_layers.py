...
def unet(input_size=(256, 256, 3)):
    ...
    up6 = layers.Conv2DTranspose(256, (3, 3), strides=(2, 2), padding='same')(conv5)
    up6 = layers.concatenate([up6, conv4])
    conv6 = layers.Conv2D(256, (3, 3), activation='relu', padding='same')(up6)

    up7 = layers.Conv2DTranspose(128, (3, 3), strides=(2, 2), padding='same')(conv6)
    up7 = layers.concatenate([up7, conv3])
    conv7 = layers.Conv2D(128, (3, 3), activation='relu', padding='same')(up7)

    up8 = layers.Conv2DTranspose(64, (3, 3), strides=(2, 2), padding='same')(conv7)
    up8 = layers.concatenate([up8, conv2])
    conv8 = layers.Conv2D(64, (3, 3), activation='relu', padding='same')(up8)

    up9 = layers.Conv2DTranspose(32, (3, 3), strides=(2, 2), padding='same')(conv8)
